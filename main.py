...
with app.app_context():
    db.session.add_all(get_users_list(users))
    db.session.add_all(get_orders_list(orders))
    db.session.add_all(get_offers_list(offers))
    db.session.commit()
...
# Роуты для добавления пользователя, обновления информации о пользователе, удалении пользователя
...
# Роуты для добавления заказа, обновления информации о заказе, удалении заказа
...
# Роуты для добавления предложения, обновления информации о предложении, удалении предложения
